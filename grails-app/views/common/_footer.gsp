...
<div class="social-media-content" style="border:0px solid black; margin-top:10px;" >
 ...
 <div class="copyright">
		<span size="6" style="vertical-align:20px;font-size: 10px; font-family:'open sans',Helvetica,sans-serif; color: rgb(153, 153, 153);border:0px solid black"> Copyright © 2017 ICBI. All Rights Reserved &nbsp;&nbsp;&nbsp;&nbsp;
		 ...
		 <br/>
                <span size="6" style="vertical-align:40px;font-size: 10px; font-family:'open sans',Helvetica,sans-serif; color: #005CA7;border:0px solid black">
                        ...
                        <g:link controller="home" action="tutorials"><g:message code="common.footer.tutorials" /></g:link> &nbsp; |&nbsp;&nbsp;
