                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:historyInstance, field:'dateCreated')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="study" action="show" id="${historyInstance?.study?.id}">${historyInstance?.study?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="GDOCUser" action="show" id="${historyInstance?.user?.id}">${historyInstance?.user?.encodeAsHTML()}</g:link></td>
