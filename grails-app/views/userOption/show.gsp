...
<html>
    ...
    <body>
        ...
        <div class="body">
            <p style="font-size:14pt;padding:10px">Show UserOption</p>
                ...
                <table class="admin" width="100%">
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:userOptionInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${userOptionInstance?.type?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="GDOCUser" action="show" id="${userOptionInstance?.user?.id}">${userOptionInstance?.user?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:userOptionInstance, field:'value')}</td>
