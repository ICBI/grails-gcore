GRANT CREATE MATERIALIZED VIEW TO ${projectName};
GRANT CREATE PROCEDURE TO ${projectName};
GRANT CREATE PUBLIC SYNONYM TO ${projectName};
GRANT CREATE SEQUENCE TO ${projectName};
GRANT CREATE SESSION TO ${projectName};
GRANT CREATE SYNONYM TO ${projectName};
GRANT CREATE TABLE TO ${projectName};
GRANT CREATE VIEW TO ${projectName};
GRANT CREATE TRIGGER to ${projectName};
